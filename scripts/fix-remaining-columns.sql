...
ALTER TABLE market_metrics_history ADD COLUMN IF NOT EXISTS timestamp TIMESTAMP WITH TIME ZONE DEFAULT NOW();
ALTER TABLE market_metrics_history ADD COLUMN IF NOT EXISTS token_address VARCHAR(44);
